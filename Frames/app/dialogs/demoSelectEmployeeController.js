angular.module('app').controller('demoSelectEmployeeController', ['$scope', 'dataService', function($scope, dataService) {
    ...
    $scope.saveSettings = function() {
        $scope.item.settings.id = $scope.selectedEmployee.id;
